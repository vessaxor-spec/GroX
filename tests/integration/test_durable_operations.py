...
class DurableOperationsIntegrationTests(unittest.TestCase):
    def test_interrupted_graph_resumes_without_replaying_committed_work_and_handles_two_exceptions(self):
        ...
        try:
            ...
            architecture_orders=[o for o in before['orders'] if o['crew_id']=='systems-architect']
            ...
            self.assertEqual(len([o for o in mission['orders'] if o['crew_id']=='systems-architect']),1)
