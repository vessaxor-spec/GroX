...
5. `docs/stewardship/ROADMAP.md`
6. `docs/stewardship/progress-tracker.md`
7. Code and tests

The repository is currently establishing the GroX-native baseline before the previously built Vessel implementation is recovered and reconciled.
