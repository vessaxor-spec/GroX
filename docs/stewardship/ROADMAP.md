...
The current strategic program is **Native Cognition Independence Program 001 — implementation in progress**. **NCI-1, NCI-2, and NCI-3 are qualified. The Commander-designated immediate next bounded priority is Live Environment Awareness (issue #115; doctrine PR #116 to be reconciled against post-NCI-3 truth). NCI-4 remains the next numbered Native Cognition Independence stage after that priority unless later replanned.** No roadmap item inherits qualification merely because it is listed here. The Prime Function and orchestration doctrine constrain every stage: evolution must improve or preserve GroX as the Commander's AI personal assistant, keep GorXu at the helm above Divisions/Crew, and cannot create independent purpose.
