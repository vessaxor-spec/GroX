...
GroX `v0.8.0` is the current published Post-Apex Operational Evolution baseline while canonical source continues through protected `main`. The Vessel has 82 Standing Crew, three-plane persistence, qualified A1-A7 Apex behavior, protected CI across Python 3.11-3.14 plus wheel bootstrap, continuous critical-detector mutation proof, a native read-only Vessel health surface, tiered reconstitution planning, controlled context heat, A6 longitudinal operational drift analysis, privacy-safe Mission-to-source provenance, Mission Outcome Truthfulness, bounded Selective Deep-Craft Crew Cognition, one canonically qualified **live locally trained neural Crew cognition provider**, and a **qualified NCI-1 native cognition runtime + local Vessel foundation, qualified NCI-2 built-in local seed cognition, qualified NCI-3 offline GorXu conversational cognition, qualified bounded Live Environment Awareness local-runtime exit, qualified governed Tool Gateway capability-awareness exit, qualified bound hosted/session cognition-awareness exit, qualified bound remote cognition origin transport-freshness exit, qualified exact bound remote endpoint-surface freshness exit, qualified supported configured cognition-resource discovery exit, qualified configured remote cognition connection-policy awareness exit, qualified configured local llama.cpp readiness awareness exit, qualified governed secret-alias availability awareness exit, qualified configured cognition credential-alias binding awareness exit, and qualified configured cognition credential-alias availability composition exit**.

The Commander has set a strategic direction: **GroX should own its cognition lifecycle and become capable of operating locally/offline without requiring a paid model subscription or vendor-hosted reasoning session.** GroX will evolve its own native cognition runtime and local model family while treating external models such as OpenAI, Anthropic, Google, and future providers as optional governed capabilities rather than required pilots. NCI-1 qualifies the local runtime/install/model-control foundation required for that direction, NCI-2 qualifies a bounded built-in local language seed for an installed personal-assistant + orchestration cognitive Mission without a vendor credential or external network, and NCI-3 now qualifies one bounded offline GorXu conversational operating profile: direct Commander↔GorXu assistance without Mission creation, natural-language interpretation/planning, governed Crew delegation, high-risk Inspect execution, synthesis, independent verification, and fail-closed reconstitution without vendor credentials or an external route. This does **not** qualify NCI-4 neural Crew evolution, every personal-assistant/tool surface as offline, a public installer/desktop launcher, or a GroX-pretrained foundation model.
...
- **NCI-3 is QUALIFIED:** issue #113 / PR #114 qualify the bounded offline GorXu conversational profile on the same exact Qwen3-4B Q4_K_M seed and pinned llama.cpp b10218 path. Exact-head GroX CI #353 / `32642076863` and NCI-3 Offline GorXu Qualification #7 / `32642076857` passed on PR head `900d6bbb7f2683844a2182095cce67f374ae4592`; installed `grox ask` answered locally without creating a Mission, delegating Crew, or changing authority; the same offline profile then completed a governed high-risk Inspect Mission with `application-security-engineer`, synthesis, independent PASS by `code-reviewer`, no mutation or cognition degradation, and reconstitution to zero active models. PR #114 merged as `main@a21c9999d220952bff2397754e66c9480de3a750`; canonical tree `e1d89e1c2e64b3422abb4db72f5263eb757bca03` exactly matches the CI-tested synthetic merge tree.

- **Live Environment Awareness governed Tool Gateway capability-awareness exit is QUALIFIED:** issue #122 / PR #123 add fresh read-only Pilot-owned awareness for the existing A5 isolated-workspace, network-fetch, browser-capture, and MCP capability surface. Host policy/readiness remains distinct from exact sealed-Mission authorization; inventory invokes no governed capability, creates no Mission, persists no new operational state, and widens no authority. Exact-head CI #394 / `32653017307` passed Wheel plus Python 3.11–3.14; Python 3.12 recorded pytest 354 passed / 2 skipped / 449 subtests, unittest 356 / 2 skipped, mutations 14/14 + 7/7 + 9/9 + 4/4 + 6/6 killed, and Post-Apex PASS. PR #123 merged as `main@bdbd08a11bb93594dbf84c2fc0e81266ca6dc243`; canonical tree `a4a537983d242988b747d04668055cbd0c2e047b` exactly matches the CI-tested synthetic merge tree. Parent issue #115 remains broader and open.
- **Live Environment Awareness bound hosted/session cognition-awareness exit is QUALIFIED:** issue #125 / PR #126 add fresh privacy-safe Pilot-owned awareness for hosted/session cognition providers already bound to GorXu or Crew cognition seats. Binding/discovery, authorization, current readiness, qualification/fit, existing binding selection, and prior observation remain distinct; qualification does not imply authorization, prior remote execution does not imply current remote readiness, and inventory performs no callback/network invocation or provider switching. Exact-head CI #410 / `32661093847` passed Wheel plus Python 3.11–3.14; Python 3.12 recorded pytest 364 passed / 2 skipped / 449 subtests, unittest 366 / 2 skipped, mutations 15/15 + 7/7 + 9/9 + 4/4 + 6/6 killed, and Post-Apex PASS. PR #126 merged as `main@6be03b46ac02d121c8ef7e90c25341504fd1d020`; canonical tree `50bf3333eabb066a74b0e62538ea741d7038a106` exactly matches the CI-tested synthetic merge tree. Parent issue #115 remains broader and open; provider/service readiness beyond origin transport freshness, credential validity, unbound discovery, broader authorized external-connection/application awareness, and adaptive provider/resource routing remain unqualified.
- **Live Environment Awareness bound remote cognition transport-freshness exit is QUALIFIED:** issue #128 / PR #129 add explicit current-session exact-origin transport evidence for an already-bound remote cognition resource under an already sealed Mission Order and existing A5 Tool Gateway authority. Exact-head CI #426 / `32710787713` passed Wheel plus Python 3.11–3.14; Python 3.12 recorded Vessel Health 10/0/0/0, pytest 373 passed / 2 skipped / 453 subtests, unittest 375 / 2 skipped, critical mutations 16/16 plus 7/7 + 9/9 + 4/4 + 6/6 killed, and Post-Apex PASS. PR #129 merged as `main@922a35add9c92e7e0d7eed31dc1ff80895e28e61`; canonical tree `9cc6ed2765cfc226e279ae498ebabd6ade675bd5` exactly matches the CI-tested synthetic merge tree. The observation proves transport only and never sets remote provider readiness, authorization, or qualification. Parent #115 remains open.
- **Live Environment Awareness exact bound remote endpoint-surface freshness exit is QUALIFIED:** issue #136 / PR #137 add credential-free current-session evidence that the exact configured HTTP(S) endpoint path of one already-bound remote cognition resource produced a bounded HTTP response under explicit already-sealed exact `net_fetch` authority and the existing Tool Gateway origin policy. Exact-head CI #463 / `32742888955` passed Wheel plus Python 3.11–3.14 on head `f86b6dff1cc73b8487ed09ce58720dc4c09f3677`; Python 3.12 recorded Vessel Health 10/0/0/0, pytest 386 passed / 2 skipped / 463 subtests, unittest 388 / 2 skipped, critical mutations 18/18 plus 7/7 + 9/9 + 4/4 + 6/6 killed, and Post-Apex PASS. CI-tested synthetic merge `0daa8fe53f1c3d13b7a1a61b7d5d9a18a8348488` and canonical merge `main@2b516b8b5e4757c216e5fe561db5325a1471f6de` share exact tree `581b492e285f85a43680cb6315ae299b1ea85f33`. The observation proves endpoint-surface response only; credentials, authenticated provider/service readiness, model availability/fitness, cognition success, provider qualification, selection/fallback, adaptive routing, and remote `ready=True` remain unqualified. Parent #115 remains open.
- **Live Environment Awareness supported configured cognition-resource discovery exit is QUALIFIED:** issue #140 / PR #141 add passive privacy-minimized discovery for cognition resources represented by the repository-supported non-secret reasoning configuration kinds `openai` and `local-llama-cpp`. Discovery reads only provider/model/endpoint identity, performs no provider construction or binding, credential inspection, network I/O, executable/model load, cognition invocation, Mission creation, fallback, or routing, and establishes `Discovered` only. Exact-head CI #476 / `32771922889` passed Wheel plus Python 3.11–3.14 on head `37a0fabe5efbe8d378f3abe11f825316fd468401`; Python 3.12 recorded Vessel Health 10/0/0/0, pytest 392 passed / 2 skipped / 467 subtests, unittest 394 / 2 skipped, critical mutations 19/19 plus 7/7 + 9/9 + 4/4 + 6/6 killed, and Post-Apex PASS. CI-tested synthetic merge `5f83c2773c1890b127fd2abbcf178f3e85ef4b03` and guarded canonical merge `main@bf3d0f622ed4088330324f865611e40a4466ae59` share exact tree `baf7841fabbdc02b91fcc750fedc02b0a4e8f929`. Credential validity, authenticated provider/service readiness, model existence/availability/fitness, cognition success, arbitrary/unconfigured provider catalog discovery, broader external-connection/application/process awareness, switching/fallback, and adaptive routing remain unqualified. Parent #115 remains open.

- **Live Environment Awareness configured remote cognition connection-policy awareness exit is QUALIFIED:** issue #144 / PR #145 add read-only policy awareness for one valid configured remote `openai` cognition endpoint. Host Tool Gateway permission is reported separately from Mission authorization; `authorized=True` requires an already sealed Order with exact `net_fetch`, `operation=configured_cognition_connection_authorization`, exact configured resource ID, exact endpoint, and exact normalized origin permitted by host policy. The surface performs no network request, credential inspection, provider/model activation, cognition invocation, readiness/fitness promotion, selection, fallback, or routing. Exact-head CI #491 / `32775200609` passed Wheel plus Python 3.11–3.14 on head `c6257872847746b0ef913f2291a6634ac206cc2b`; Python 3.12 recorded Vessel Health 10/0/0/0, pytest 399 passed / 2 skipped / 470 subtests, unittest 401 / 2 skipped, critical mutations 20/20 plus 7/7 + 9/9 + 4/4 + 6/6 killed, and Post-Apex PASS. The permanent `configured-connection-exact-resource-binding` mutation was killed. CI-tested synthetic merge `14ac96d070c4c5f22005de3b1a170128dc9b7b88` and guarded canonical merge `main@ef88cf34ea6732b65cf2ca461d06076d6af1221b` share exact tree `1480d54f15a4713a083e53cb7174ed8c6c244adf`. Credential validity, authenticated provider/service readiness, model existence/availability/fitness, cognition success, broader external-connection/application/process awareness, switching/fallback, and adaptive routing remain unqualified. Parent #115 remains open.
...
**Status: IMPLEMENTATION IN PROGRESS — NCI-1 + NCI-2 + NCI-3 QUALIFIED; LIVE ENVIRONMENT AWARENESS IN PROGRESS — LOCAL-RUNTIME + GOVERNED TOOL GATEWAY + BOUND HOSTED COGNITION + BOUND REMOTE TRANSPORT FRESHNESS EXITS QUALIFIED.** This program follows the first live local neural qualification and the canonical Prime Function/vendor-independence decisions. It is not A8, does not change the current release, and grants no additional authority. Every stage remains subordinate to Commander intent and the Prime Function doctrine.
...
NCI-1 establishes and now qualifies the GroX-owned runtime/install boundary required before local seed cognition can become a real product capability.
...
- deterministic model registry and model lineage validation;
- provider-neutral local inference backend contract;
- host hardware/runtime discovery and deterministic resource readiness;
- explicit Crew cognition placement without changing hierarchy;
- local model readiness evidence for available/unavailable/corrupt/unsupported states;
- explicit load/invoke/unload behavior;
- fail-closed backend/runtime failure handling;
- reconstitution that clears active model state and never auto-activates a registered model;
- the already-qualified `tiny-mlp-policy-5x8x3-v1` registered as the first model without relabeling it as language-capable.

Preserved red evidence: candidate `1833310769d443ef18f0fb8fce6262e92b5ab712` / run **280 / `32392662853`** exposed Python 3.11 trained-weight reproduction drift. The digest gate contained the mismatch. The final design packages the exact already-qualified trained weights rather than weakening identity checks.

Final implementation head `2d68b63222cc69883d7c4252cbeeaaa9b6e5fb46` passed run **281 / `32393064902`** across all five canonical CI jobs, and PR #100 merged as `8dde1a1714c38850c681623f1aba9238d6ec8b20`. Issue #99 closed completed.

#### NCI-1 installed-wheel exit proof — COMPLETE / QUALIFIED

Post-NCI-1D inspection found one legitimate remaining overall exit gap: packaged runtime installation and source-qualified model runtime had not yet met in one permanent non-editable-wheel proof outside the checkout.

Issue #101 / PR #102 closed that evidence gap without runtime redesign. Exact head `689f1e1f77f49d9ea6eb5fb5fda49c54da3e6d6a` passed run **283 / `32406301653`** across all five jobs and permanently proved the installed wheel can:

- resolve packaged runtime assets;
- construct the packaged model registry;
- find `tiny-mlp-policy-5x8x3-v1` `AVAILABLE` but inactive;
- explicitly load it with Crew placement;
- invoke it through the GroX-owned runtime contract;
- report no authority change;
- unload/reconstitute with no active model and no auto-activation.

Python 3.12 recorded **294 passed, 2 skipped, 440 subtests** in pytest and **296 OK, 2 skipped** in unittest. Mutation gates remained **12/12, 7/7, 9/9, 4/4, 6/6** killed and integrated Post-Apex qualification remained PASS with GorXu sole-orchestrator proof intact.

PR #102 merged as `main@41fa4944d1b3e3011561a346b066df54be176a78`. Canonical tree `734e5b1762271045f0e4ac91c3f66334bdc13361` exactly matches CI-tested synthetic merge `34dbcb11831a4c5eccbfc5fb3211720ba94f4510` tree `734e5b1762271045f0e4ac91c3f66334bdc13361`.
...
NCI-2 alone did not qualify the broader NCI-3 conversational/offline GorXu profile; NCI-3 is now separately qualified through issue #113 / PR #114. Neither qualification implies a public installer or desktop launcher, model self-activation, a release/tag change, NCI-4, or A8.

#### NCI-3 — Offline GorXu cognition — COMPLETE / QUALIFIED
...
**NCI-3 exit evidence: PASSED.** Issue #113 / PR #114 established the full bounded exit on Linux x86_64 with >=8 GiB RAM/free working disk, CPU-only operation and at most four inference threads. The non-editable installed wheel used the exact Qwen seed `qwen3-4b-q4-k-m-seed-v1` / SHA-256 `7485fe6f11af29433bc51cab58009521f205840f5b4ae3a32fa7f92e8534fdf5` and pinned llama.cpp b10218 / `de699957b`; network execution was loopback-only with vendor credentials absent. Direct `grox ask` returned a useful local response with `mission_created=false`, `crew_delegated=false`, and `authority_changed=false`. A natural-language high-risk Inspect objective then produced local interpretation/planning, routed through the existing deterministic authority path to `application-security-engineer`, completed without mutation, returned Pilot synthesis, and received independent verification PASS from `code-reviewer`. Reconstitution cleared the active Qwen model without auto-activation or authority change. Exact-head CI #353 / `32642076863` and live qualification #7 / `32642076857` passed on `900d6bbb7f2683844a2182095cce67f374ae4592`; canonical merge `a21c9999d220952bff2397754e66c9480de3a750` has tree `e1d89e1c2e64b3422abb4db72f5263eb757bca03`, exactly equal to the CI-tested synthetic merge tree.
...
- that NCI-3 qualification means GroX has a GroX-pretrained foundation model, every assistant/tool surface offline, a public installer/desktop launcher, or NCI-4 neural Crew evolution;
...
- that listing Soup as an NCI-4 candidate means it is adopted, qualified, bundled, required, or part of GroX's command/runtime architecture;
...
The current strategic program is **Native Cognition Independence Program 001 — implementation in progress**. **NCI-1, NCI-2, and NCI-3 are qualified. Live Environment Awareness (issue #115) remains the Commander-designated bounded priority before NCI-4 and now has 27 qualified exits.** Since the first local/runtime awareness exits, protected source has additionally qualified exact configured credential-use authorization, governed configured remote reasoner activation, official OpenAI authenticated model visibility, governed configured cognition invocation, Mission-interpretation fitness, explicit configured cognition selection, selected invocation/observation, timeout-only fallback, current-gate route admission, volatile readiness freshness, deterministic current route planning, execution-time freshness, exact attempt-performance evidence, bounded exact-history ranking, bounded multi-resource configured cognition catalog discovery, and catalog-wide configured credential binding. **Issue #203 — catalog-wide configured cognition credential-alias availability — is the next bounded implementation.** Catalog alias availability must remain distinct from credential validity, authorization, readiness, qualification/fit, selection, observation, routing, or cognition success. Broader ambient application/process awareness and broader provider-family/catalog expansion remain unqualified. NCI-4 remains the next numbered Native Cognition Independence stage after this priority unless later replanned. No roadmap item inherits qualification merely because it is listed here. The Prime Function and orchestration doctrine constrain every stage: evolution must improve or preserve GroX as the Commander's AI personal assistant, keep GorXu at the helm above Divisions/Crew, and cannot create independent purpose.
...
- advertise the public one-command installer, desktop launcher, or general native language model before implementation and qualification evidence exist; NCI-1 standalone installed/local-model qualification, NCI-2 built-in local seed qualification, and NCI-3 offline GorXu conversational qualification may be described only within their exact bounded claims.

## Release posture

Post-Apex Evolution Program 001 qualification is complete, canonical, and post-merge verified. `v0.8.0` is published from `27da3cbbe60fb53e88af325baeb3fbb3b4adbfeb` after exact-head candidate CI `32014558365` and canonical post-merge CI `32015076306` passed. Issue #55 is complete. Canonical source has since advanced through protected-main hardening, bounded post-Apex evolution, **qualified NCI-1 native cognition runtime/local Vessel foundations, qualified NCI-2 built-in local seed cognition, and qualified NCI-3 offline GorXu conversational cognition** without moving the immutable release tag. Native Cognition Independence Program 001 remains active with **NCI-1 through NCI-3 qualified; Live Environment Awareness in progress with 27 bounded exits qualified through catalog-wide configured credential binding, with issue #203 next before the next numbered NCI stage**; it is subordinate to the Prime Function and GorXu command doctrine and does not itself make a release decision. Future release or evolution decisions remain Commander-controlled. No new Apex stage or A8 is implied.
