...
**Current released baseline:** GroX `v0.7.1@f7ed57dc9dac2eb9de7857fffb743ecdf27f05f2` / **APEX QUALIFIED** / **82 Standing Crew**. Canonical source continues on `main`.
...
- package runnable
- Commander Seat live
- bounded Mission Orders enforced
- persistent SQLite state live
- Tool Gateway root confinement live
- Inspect/Repair separation live
- independent verification path live
