...
An order is complete only when its required outcome, evidence, verification state, exceptions, and final disposition have been recorded in the Mission state.
